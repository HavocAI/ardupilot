...
{
    // Check for RPM 0 (engine has not yet started or has spooled all the way down)
    if (ctx.get_backend()->get_engine_data().rpm == 0)
    {
        // GCS_SEND_TEXT(MAV_SEVERITY_WARNING, "[MarineICE] 0 RPM in RUN_NEUTRAL.");
