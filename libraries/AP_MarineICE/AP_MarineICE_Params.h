...
public:
    ...
    AP_Int8 safe_trim;    // maximum trim level to allow the engine to run (deg)
    ...
    AP_Int8 water_depth_check_enabled; // whether to check water depth (0:disabled, 1:enabled)
