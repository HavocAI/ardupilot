...
void AP_Ilmor::trim_state_machine()
{
    ...
    switch (_trimState) {
        ...
        case TrimState::Manual:
        {
            ...
            if (_auto_trim_down.get() == 1 && _current_trim_position > _auto_trim_down_threshold.get() && AP_HAL::millis() - _last_auto_trim_down_ms > (uint32_t)_auto_trim_down_period.get()) {
